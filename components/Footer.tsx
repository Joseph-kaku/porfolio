...
<footer>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Contact Me. Joseph Kaku. © 2024 </span>
        <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://github.com/Joseph-kaku" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
            ...
            <a href="https://www.linkedin.com/in/joseph-kaku/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
